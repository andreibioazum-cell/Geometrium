...
struct engine {
    ...
    GLuint program, invProgram, uiProg;
    GLuint texGrassTop, texGrassSide, texGrassDown;

    float camPos[3], camRot[2], velY;
    float joyX, joyY, moveDirX, moveDirZ, lastTouchX, lastTouchY;
    bool isMoving, onGround, worldLoaded, meshDirty;
    ...
    int gameState, worldSeed, seedDigits[6], seedCursor;
};
